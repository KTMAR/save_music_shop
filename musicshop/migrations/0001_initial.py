    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('new', 'Новый заказ'), ('in_progress', 'Заказ в обработке'), ('is_ready', 'Ожидает в пункте выдачи'), ('completed', 'Выполнен')], default='new', max_length=100, verbose_name='Статус заказа')),
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(blank=True, related_name='related_customer', to='musicshop.Order', verbose_name='Заказы'),
        ),
        migrations.AddField(
            model_name='customer',
            name='user',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cart', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='musicshop.cart', verbose_name='Корзина')),
                ('content_type', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='contenttypes.contenttype')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='musicshop.customer', verbose_name='Владелец')),
            ],
            options={
